// Central UI configuration for Vicinity's branding, navigation items, and shared styles.
// Exports constants consumed by Navbar, Footer, and various form components across the app.
...
// Global site branding and reusable style tokens
...
// Landing page section anchors used in the Navbar
